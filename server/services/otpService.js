            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                ...
                <div style="background: #f9f9f9; padding: 32px; border-radius: 0 0 8px 8px;">
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        <a href="https://food-ai-rescue.vercel.app/?action=verify&code=${code}" style="background: #ea580c; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px rgba(234, 88, 12, 0.25);">
                            Kembali ke Aplikasi
                        </a>
                    </div>
                    <hr style="border: none; border-top: 1px solid #e0e0e0; margin: 30px 0 24px 0;">
