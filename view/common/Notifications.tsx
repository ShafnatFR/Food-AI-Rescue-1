    ...
    if (role === 'provider') {
        ...
        claimHistory.forEach(c => {
            if (currentUserId && String(c.providerId) === String(currentUserId)) { 
                ...
                else if (c.status?.toUpperCase() === 'PENDING' || c.status?.toUpperCase() === 'IN_PROGRESS' || c.status?.toUpperCase() === 'ACTIVE') {
                    list.push({
    ...
    if (role === 'receiver') {
        claimHistory.forEach((c) => {
            if (currentUserId && String(c.receiverId) === String(currentUserId)) {
                if (c.status?.toUpperCase() === 'PENDING' || c.status?.toUpperCase() === 'IN_PROGRESS' || c.status?.toUpperCase() === 'ACTIVE') {
                    list.push({
